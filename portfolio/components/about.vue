...
<div class="bg-white   p-4 flex items-center ">
  <div class="max-w-7xl mx-auto h-max px-6 md:px-12 xl:px-6">
    <div class="md:w-2/3 lg:w-1/2 ml-4">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-gray-100">
        <path fill-rule="evenodd"
          ...
          clip-rule="evenodd" style="color:rgb(165, 162, 0)"></path>
      </svg>
      <h2 class="my-8 text-2xl font-bold text-gray-800 md:text-4xl">How we work?</h2>
      <p class="text-gray-800">We follow our process to get you started as quickly as possible</p>
    </div>
    <div
